...
export function AddCostumerContainer() {
  ...
  async function Registrar(e) {
    ...
    let res = await axios.post(
      'https://pipocar.dnsabr.com/app/mpesa-dashboard/cad-agent.php',
    ...
    if (
      ...
      res.data.status_text === 'user-exist'
    ) {
      setmessage('Usuario ja existe')
    }
    if (typeof res.data.status_text === 'string') {
      res.data.user_exist === 'user-exist' &&
        setmessage('codigo do agente ja existe')
    }
  }
        ...
        <form onSubmit={Registrar}>
          ...
          <div>
            ...
            <input
              ...
              type="number"
              onChange={e => setinitialinvestiment(e.target.value)}
            />
            ...
            <input
              ...
              placeholder="Data"
              type="date"
              onChange={e => setbitrhdate(e.target.value)}
            />
            ...
            <input
              required
              placeholder="Numero de telefone do operador"
              type="number"
            ...
            <input
              ...
              type="number"
              onChange={e => setagent_code(e.target.value)}
            />
