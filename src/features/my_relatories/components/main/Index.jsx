...
export function Main() {
    ...
    async function fetchData() {
        let res =await  axios.post('https://pipocar.dnsabr.com/app/mpesa-dashboard/agent-weeklyearnings-permanent.php',JSON.stringify({iduser: Number(localStorage.getItem('agente_dashboard_id'))}))
