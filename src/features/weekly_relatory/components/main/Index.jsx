...
export function Main() {
  ...
  async function fetchData() {
    let res = await axios.post(
      'https://pipocar.dnsabr.com/app/mpesa-dashboard/weekly-earnings-confirmed.php'
    )
    ...
    <div className={style.costumers}>
      ...
      {costumersList.length !== 0 ? (
        <div className={style.costumers_header}>
          <h1>Relatorios semanais confirmados</h1>
        </div>
      ) : (
        <div className={style.costumers_header}>
            ...
            return (
              <div key={item.id}>
                <dl
                  ...
                  onClick={() =>
                    navigate('/weekly-relatory-item', { state: item })
                  }
                >
